...
grid.arrange(grobs = list(hackney_violin, islington_violin), top = paste("Hackney and Islington random effect samples in M", "\u2080", sep = ""), nrow = 2)
dev.off()
...
grid.arrange(grobs = list(hackney_violin_v2, islington_violin_v2), top = paste("Hackney and Islington random effect samples in M", "\u2081", sep = ""), nrow = 2)
dev.off()
```